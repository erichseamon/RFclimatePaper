...
#rmarkdown::render(input = "/dmine/code/git/RFclimatePaper/appendices/seamon_PHD_appendix_C.Rmd", output_file = paste("/dmine/code/git/RFclimatePaper/appendices/seamon_PHD_appendix_C.html", sep=""))
...
countiesfips <- read.csv("/mnt/ceph/erichs/git/RFclimatePaper/data/counties/counties_fips.csv", 
...
wheatprice <- read.csv("/tmp/wheat_prices_1989_2015.csv", header = TRUE, strip.white = TRUE, sep = ",")
...
plot(fd_loss$x ~ fd_loss$Group.1, col = "red", cex.lab = 2.5, cex.main = 2, cex.axis = 2, las = 2, yaxt = "n", xaxt = "n", xlab = "", ylab = "", main = paste("24 county iPNW study area: R2 = ", r2, " RMSE = ", rmse, sep=""))

---
title: 'Supplemental Materials: Random Forest Climatic Modeling of Agricultural Insurance Loss Across the Inland Pacific Northwest Region of the United States'
...
counties <- counties[counties$NAME != "Clearwater",]
      ...
      counties3 <- merge(counties2, bestcounty2, by = "NAME")
            counties3$ENDMONTH <- as.numeric(counties3$ENDMONTH)+1
  ...
  counties3$CORRELATION <- as.numeric(counties3$CORRELATION)    
    ...
    if(reverse_order){ 
      ...
      map <- leaflet(data = counties3) %>% 
        ...
        addLabelOnlyMarkers(data = counties3, lng = lat_long[,1], lat = lat_long[,2], label = lapply(labs2, HTML), labelOptions = labelOptions(noHide = TRUE, direction = 'middle', textOnly = TRUE, textsize = "14px", col = "white", style=list(
        ...
        addLegend(pal = pal2, values = counties3$CORRELATION,  labels = c("1", "2"), opacity = .5, title = paste("Optimum", "Correlation", sep="<br>"),
...
counties3$CORRELATION <- as.numeric(counties3$CORRELATION)      
      ...
      map <- leaflet(data = counties3) %>% 
        ...
        addLegend(pal = pal, values = counties3$CORRELATION,  labels = c("1", "2"), opacity = .5, title = paste("Optimum",  "Correlation", sep="<br>"),
